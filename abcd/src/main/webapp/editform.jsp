...
<br>
  <div class="form">
  <h2><b>EDIT NOTEBOOK NAME</b></h2>
    <form class="login-form" action="<%=request.getContextPath()%>/savename" method="post"> 
    <input type="hidden" name="id" value="<c:out value='${todo.id}'/>"/>
    <input type="text" name="name" value="<c:out value='${todo.name}'/>" required autocomplete="off"/>
      <button>Save</button>
    </form>
  </div>
</div>
