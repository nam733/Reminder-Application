...
<br>
  <div class="form">
  <h2><b>ADD NOTEBOOK</b></h2>
    <form class="login-form" action="<%=request.getContextPath()%>/addnotebook" method="post"> 
    <input type="text" name="notebookname" placeholder="NoteBookName" required autocomplete="off"/>
